    ...
    <div className="min-h-screen bg-[#020817] flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center">
        ...
        <div className="relative z-10 px-12">
          ...
          <h2 className="font-black text-4xl text-white mb-4 leading-tight">Start your adaptive<br />learning journey</h2>
          <p className="text-slate-500 text-base leading-relaxed mb-10">Create your free account and let XGBoost AI tailor every quiz window to your unique performance profile.</p>
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={i} className="flex items-center gap-3 group">
                <div className="w-7 h-7 rounded-lg bg-cyan-500/15 border border-cyan-500/25 flex items-center justify-center flex-shrink-0 text-sm group-hover:scale-110 transition-transform">
                  {f.icon}
                </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 relative">
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <h1 className="font-black text-3xl text-white mb-1">Create account</h1>
          <p className="text-slate-500 text-sm mb-8">
            Already have an account?{' '}
            <Link to="/login" className="text-cyan-400 hover:text-cyan-300 font-bold transition-colors">Log in</Link>
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="sm:col-span-2">
                <label className="block text-[10px] font-bold text-slate-600 uppercase tracking-[0.15em] mb-2">Full Name</label>
            ...
            <div>
              <label className="block text-[10px] font-bold text-slate-600 uppercase tracking-[0.15em] mb-2">Confirm Password</label>
