  ...
  return (
    <div className="min-h-screen bg-[#020817] flex overflow-hidden">
      <style>{`
        ...
        .feature-chip:hover { transform: translateY(-2px) scale(1.02); border-color: rgba(6,182,212,0.3) !important; background: rgba(6,182,212,0.08) !important; }
        ::placeholder { color: rgba(100,116,139,0.6); }
      `}</style>

      {/* Left decorative panel */}
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center"
        style={{ animation: mounted ? 'slideInLeft 0.7s ease forwards' : 'none' }}>
        ...
        <div className="absolute bottom-1/3 left-16 w-10 h-10 rounded-xl flex items-center justify-center text-xl opacity-20"
          style={{ animation: 'floatY 5s ease-in-out 1s infinite', background: 'rgba(59,130,246,0.1)', border: '1px solid rgba(59,130,246,0.2)' }}>
          🏆
        </div>
        ...
        <div className="relative z-10 text-center px-12">
          ...
          <div className="flex items-center gap-3 justify-center mb-12 cursor-pointer group" onClick={() => navigate('/')}>
            <div className="relative w-12 h-12">
              ...
              <div className="relative w-12 h-12 rounded-2xl bg-gradient-to-br from-cyan-400 to-blue-600 flex items-center justify-center shadow-xl group-hover:shadow-cyan-500/40 transition-shadow duration-400">
          ...
          <h2 className="font-black text-4xl text-white mb-4 leading-tight" style={{ fontFamily: "'Syne',sans-serif" }}>
            Welcome back,<br />ready to level up?
          </h2>
          <p className="text-slate-500 text-base leading-relaxed mb-12">
            Your AI is waiting. Log in to get a personalised 20-question quiz based on your latest performance.
          </p>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 relative"
        style={{ animation: mounted ? 'slideInRight 0.7s ease forwards' : 'none' }}>
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <h1 className="font-black text-3xl text-white mb-1" style={{ fontFamily: "'Syne',sans-serif" }}>Welcome back</h1>
          <p className="text-slate-500 text-sm mb-8">
            Don't have an account?{' '}
            <Link to="/signup" className="text-cyan-400 hover:text-cyan-300 font-bold transition-colors underline underline-offset-2">Sign up free</Link>
          </p>
